package com.aperezsi.tvguide.data.ui.channel.data.tomorrow3
...
class Tomorrow3ChannelAdapter (val context: Context,
                               val layout: Int,
                               val dataList: List<ProgramResponse>) : RecyclerView.Adapter<Tomorrow3ChannelAdapter.ViewHolder>() {
